...
suite('Functional Tests', function() {
    ...
    this.timeout(5000);
    //#1
    test('Test GET request to /api/convert with your valid input', function (done) {
        chai
          .request(server)
          .keepOpen()
      ...
      //#2
      test('Test GET request to /api/convert with an invalid input', function (done) {
        chai
          .request(server)
          .keepOpen()
          ...
          .end(function (err, res) {
           ...
           //#3
           test('Test GET request to /api/convert with an invalid number', function (done) {
            chai
              .request(server)
              .keepOpen()
           ...
           //#4
           test('Test GET request to /api/convert with an invalid number AND unit', function (done) {
            chai
              .request(server)
              .keepOpen()
